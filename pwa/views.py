...
from hayek.commons import user_in_group, get_or_none, get_param, show_exc
from gestion.models import Employee, Client, Service, Infestation, ServiceType
...
def employee_service_step11(request):
    client = get_or_none(Client, get_param(request.GET, "code", "code"))
